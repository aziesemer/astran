...
${OBJECTDIR}/src/sight/model.o: src/sight/model.cpp
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/model.o src/sight/model.cpp

${OBJECTDIR}/src/interface/interface.o: src/interface/interface.cpp
	${MKDIR} -p ${OBJECTDIR}/src/interface
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/interface/interface.o src/interface/interface.cpp

${OBJECTDIR}/src/sight/states/lbl.o: src/sight/states/lbl.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight/states
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/states/lbl.o src/sight/states/lbl.cpp

${OBJECTDIR}/src/sight/label.o: src/sight/label.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/label.o src/sight/label.cpp

${OBJECTDIR}/src/sight/sight.o: src/sight/sight.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/sight.o src/sight/sight.cpp

${OBJECTDIR}/src/basicglpane.o: src/basicglpane.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/basicglpane.o src/basicglpane.cpp

${OBJECTDIR}/src/sight/states/select.o: src/sight/states/select.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight/states
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/states/select.o src/sight/states/select.cpp

${OBJECTDIR}/src/sight/opengl.o: src/sight/opengl.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/opengl.o src/sight/opengl.cpp

${OBJECTDIR}/src/sight/states/drag.o: src/sight/states/drag.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight/states
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/states/drag.o src/sight/states/drag.cpp

${OBJECTDIR}/src/sight/io_files.o: src/sight/io_files.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/io_files.o src/sight/io_files.cpp
...
${OBJECTDIR}/src/sight/fileformats/BinaryFileReader.o: src/sight/fileformats/BinaryFileReader.cpp
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/fileformats/BinaryFileReader.o src/sight/fileformats/BinaryFileReader.cpp

${OBJECTDIR}/src/sight/txGpu.o: src/sight/txGpu.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/txGpu.o src/sight/txGpu.cpp

${OBJECTDIR}/src/interface/layeritem.o: src/interface/layeritem.cpp
	${MKDIR} -p ${OBJECTDIR}/src/interface
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/interface/layeritem.o src/interface/layeritem.cpp

${OBJECTDIR}/src/sight/states/line.o: src/sight/states/line.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight/states
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/states/line.o src/sight/states/line.cpp

${OBJECTDIR}/src/app.o: src/app.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/app.o src/app.cpp

${OBJECTDIR}/src/sight/camera.o: src/sight/camera.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/camera.o src/sight/camera.cpp

${OBJECTDIR}/src/sight/rectangle.o: src/sight/rectangle.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/rectangle.o src/sight/rectangle.cpp

${OBJECTDIR}/src/sight/layer.o: src/sight/layer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/layer.o src/sight/layer.cpp

${OBJECTDIR}/src/sight/ruler.o: src/sight/ruler.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/ruler.o src/sight/ruler.cpp

${OBJECTDIR}/src/sight/wire_line.o: src/sight/wire_line.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/wire_line.o src/sight/wire_line.cpp

${OBJECTDIR}/src/sight/repository.o: src/sight/repository.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/repository.o src/sight/repository.cpp

${OBJECTDIR}/src/sight/states/sqr.o: src/sight/states/sqr.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight/states
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/states/sqr.o src/sight/states/sqr.cpp

${OBJECTDIR}/src/sight/states/wire.o: src/sight/states/wire.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight/states
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/states/wire.o src/sight/states/wire.cpp

${OBJECTDIR}/src/sight/states/rulerst.o: src/sight/states/rulerst.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight/states
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/states/rulerst.o src/sight/states/rulerst.cpp

${OBJECTDIR}/src/sight/fileformats/gds.o: src/sight/fileformats/gds.cpp
	${MKDIR} -p ${OBJECTDIR}/src/sight/fileformats
	${RM} $@.d
	$(COMPILE.cc) -O2 $(CXXFLAGS) -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sight/fileformats/gds.o src/sight/fileformats/gds.cpp
