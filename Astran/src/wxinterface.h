...
class CellGen : public wxFrame 
{
	...
	public:
		CellGen( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Cellgen"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 620,420 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~CellGen();
...
class View_Circuit : public wxFrame 
{
	...
	public:
		View_Circuit( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Circuit"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 250,300 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~View_Circuit();
...
class View_Preferences : public wxFrame 
{
	...
	public:
		View_Preferences( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Preferences"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 370,270 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~View_Preferences();
...
class Specify_FP : public wxFrame 
{
	...
	public:
		Specify_FP( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Specify Floorplan"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 450,230 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~Specify_FP();
