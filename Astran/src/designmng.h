...
static commands commands_lst[] = {
	...
	{"CELLGEN COMPACT <int_diffStretching> <int_griddedPolly> <int_rdCntsCost> <int_maxDiffCnts> <int_alignDiffConts> <int_reduceLTurns> <int_debug> <int_enableDFM> <int_timeLimit>", "Compact the cell's layout with Cellgen"},
