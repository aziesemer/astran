...
static commands commands_lst[] = {
	...
	{"CELLGEN COMPACT <int_diffStretching> <int_griddedPolly> <int_rdCntsCost> <int_maxDiffCnts> <int_alignDiffConts> <int_debug>", "Compact the cell's layout with Cellgen"},
